			...
			<div class="wrap-login100">
				...
				<form  name="f1" action="Reset-Password-en"   class="login100-form validate-form">
					...
					<div  class="wrap-input100 validate-input m-b-26" data-validate="Username is required"  >
						...
						<input   id="myDiv"  class="input100" type="text" name="email" placeholder="  Email "   >
					...
					<div class="form-submit">
						...
						<input    type="button" value="cancel " class="cancel" name="reset" id="cancel"  onclick="window.location.href = ''; return false;" />



						<input type="submit" value="Send" class="submit" name="submit" id="submit" value="register" onclick="return validate()" />
